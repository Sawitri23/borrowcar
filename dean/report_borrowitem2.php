...
<form name="frmSearch" method="GET" action="">
  <table width="1500" border="0">
    <tr><center>
      <th><center>อุปกรณ์ที่รออนุมัติการยืมระหว่างวันที่: &nbsp;&nbsp;
...
<?php
    ...
    $query = "SELECT item_name, COUNT(item_name) AS total FROM borrow WHERE b_status = 'รออนุมัติ' AND b_date between '".$search_text."' and  '".$search_text1."' or b_date LIKE '%$search_text%'and b_date LIKE '%$search_text1%' GROUP BY item_name  DESC" or die("Error:" .mysqli_error($con));
