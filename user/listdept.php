...
<thead>
  <center><tr class='danger'>
    ...
    <th width='75%'><center>ชื่อหน่วยงาน/สาขา</center></th>
...
<tbody> 
  ...
  echo "<tr>";
    ...
    echo "<td><center><a href='form.php?p=editdept1&ID=$row[0]' <button type='button' class='btn btn-warning btn-xs'> <i class='fa fa-wrench'></i> แก้ไข </center></button></a></center></td> ";
