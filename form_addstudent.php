...
<body>
  ...
  <form  name="register" action="form_adduser2.php" method="POST" class="form-horizontal">
    <div class="form-group">
      ...
      <div class="col-sm-5" align="left"> <h3><i class="fas fa-edit"></i> ฟอร์มการลงทะเบียนสำหรับ นักศึกษา </h3> <hr/></div>
    </div>
    ...
    <div class="form-group">
      <div class="col-sm-1" align="right"> </div>
      <div class="col-sm-5" align="left">
    <label for="dept_name">หน่วยงาน/สาขา</label>
    <select name="dept_name" id="dept_name" class="form-control">
      ...
      $dept_n=$record["dept_name"];
      ?>
      <option value="<?php echo "$dept_n";?>" ><?php echo "$dept_n";?></option>
      <?php } ?>
    </select>
  </div>
</div>
