...
<thead> 
  <tr class='danger'>
    ...
    <th width='10%'><center>E-mail</center></th>
    <th width='10%'><center>สิทธิ์การเข้าถึง</center></th>
...
<tbody> 
  ...
  echo "<tr>";
    ...
    echo "<td><center><a href='form.php?p=edituser1&ID=$row[0]' <button type='button' class='btn btn-warning btn-xs'> <i class='fa fa-arrow-circle-up'></i> แก้ไข</center></button></a></center></td> ";
