    ...
    <tr>
      ...
      <div class="row">
        <?php
            ...
            $data = array();
            $sql = "SELECT *, COUNT(item_name) AS total FROM borrow 
                    WHERE b_date between '".$search_text."' and  '".$search_text1."' or b_date LIKE '%$search_text%'and b_date LIKE '%$search_text1%' GROUP BY item_name ORDER BY item_name DESC"; 
...
<u><center><b><h4>รายการอุปกรณ์ที่ยืมอุปกรณ์: ระหว่างวันที่ 
  <?php 
...
echo date('d/m/Y',strtotime($_GET['txt_keyword1']));
    ...
    <td><center>รายการที่ถูกยืม</center></td>
